...
// Wrapper over all report descriptors, wrapped in an Application Collection.
// Windows requires the Application Collection wrapper for force-feedback.
// Linux is fine either way.
#define FFB_REPORT_DESCRIPTOR_CONTENT \
    HID_USAGE_PAGE(HID_USAGE_PAGE_DESKTOP), \
