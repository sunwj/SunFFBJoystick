...
#define FFB_REPORT_DESC_INPUT_PID_STATE \
    ...
    HID_COLLECTION(HID_COLLECTION_LOGICAL), \
        ...
        HID_INPUT(HID_DATA | HID_VARIABLE | HID_ABSOLUTE), \
        \
        HID_USAGE(HID_USAGE_PID_EFFECT_PARAMETER_BLOCK_INDEX), \
        HID_LOGICAL_MIN(1), \
...
#define FFB_REPORT_DESC_OUTPUT_SET_EFFECT \
    ...
    HID_COLLECTION(HID_COLLECTION_LOGICAL), \
        ...
        HID_COLLECTION(HID_COLLECTION_LOGICAL), \
            HID_USAGE(HID_USAGE_PID_ET_CONSTANTFORCE), \
...
#define FFB_REPORT_DESC_OUTPUT_SET_CONDITION \
    ...
    HID_COLLECTION(HID_COLLECTION_LOGICAL), \
        ...
        \
        /* Center-Point Offset */ \
        HID_USAGE(HID_USAGE_PID_CENTERPOINT_OFFSET), \
        HID_LOGICAL_MIN_N(-USB_AXIS_MAX_ABSOLUTE, 2), \
        HID_LOGICAL_MAX_N(USB_AXIS_MAX_ABSOLUTE, 2), \
...
#define FFB_REPORT_DESC_OUTPUT_SET_CONSTANT \
    HID_USAGE_PAGE(HID_USAGE_PAGE_PID), \
    HID_USAGE(HID_USAGE_PID_SET_CONSTANTFORCE_REPORT), \
    HID_COLLECTION(HID_COLLECTION_LOGICAL), \
...
#define FFB_REPORT_DESC_OUTPUT_SET_RAMP \
    HID_USAGE_PAGE(HID_USAGE_PAGE_PID), \
    HID_USAGE(HID_USAGE_PID_SET_RAMPFORCE_REPORT), \
    HID_COLLECTION(HID_COLLECTION_LOGICAL), \
        HID_REPORT_ID(REPORT_ID_SET_RAMP_FORCE_REPORT) \
        \
        /* Block Index */ \
        HID_USAGE(HID_USAGE_PID_EFFECT_PARAMETER_BLOCK_INDEX), \
        HID_LOGICAL_MIN(1), \
...
#define FFB_REPORT_DESC_OUTPUT_BLOCK_FREE \
    HID_USAGE_PAGE(HID_USAGE_PAGE_PID), \
    HID_USAGE(HID_USAGE_PID_EFFECT_PARAMETER_BLOCK_FREE_REPORT), \
    HID_COLLECTION(HID_COLLECTION_LOGICAL), \
...
#define FFB_REPORT_DESC_FEATURE_CREATE_NEW_EFFECT \
    HID_USAGE_PAGE(HID_USAGE_PAGE_PID), \
    HID_USAGE(HID_USAGE_PID_CREATE_NEW_EFFECT_PARAMETER_BLOCK_REPORT), \
    HID_COLLECTION(HID_COLLECTION_LOGICAL), \
...
#define FFB_REPORT_DESC_FEATURE_BLOCK_LOAD \
    HID_USAGE_PAGE(HID_USAGE_PAGE_PID), \
    HID_USAGE(HID_USAGE_PID_EFFECT_PARAMETER_BLOCK_LOAD_REPORT), \
    HID_COLLECTION(HID_COLLECTION_LOGICAL), \
        ...
        \
        /* Block Load Status */ \
        HID_USAGE(HID_USAGE_PID_EFFECT_PARAMETER_BLOCK_LOAD_STATUS), \
        HID_COLLECTION(HID_COLLECTION_LOGICAL), \
...
#define FFB_REPORT_DESC_FEATURE_POOL_REPORT \
    HID_USAGE_PAGE(HID_USAGE_PAGE_PID), \
    HID_USAGE(HID_USAGE_PID_PARAMETER_BLOCK_POOLS_REPORT), \
    HID_COLLECTION(HID_COLLECTION_LOGICAL), \
        ...
        HID_USAGE(HID_USAGE_PID_DEVICEMANAGED_POOL), \
